...
namespace Silk
{
    ...
    string("\t\t") + PositionOutName + " = (" + InstanceTransformAttribName + " * _Pos).xyz;\n";
    ...
    "\t\t\t\t}\n\n"                                                                                                                   +
    "\t\t\t\t//Light equation\n"                                                                                                      +
    "\t\t\t\tvec4 FinalColor = (ndotl * sColor * u_Lights[l].Color) + (sColor * 0.4);// + (SpecularPower * u_Lights[l].Color * sSpecular);\n" +
    "\t\t\t\t//Attenuation\n"                                                                                                         +
...
"{\n"
"	   IterationCount++;\n"
"	   if(IterationCount > u_MaxParallaxLayers) break;\n"
